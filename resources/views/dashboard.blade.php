                                        ...
                                        <div class="list-group-item">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="my-0 text-muted small">New layout has been attached
                                                        to the menu</div>
                                                </div>
                                                <div class="col-auto">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row border-top">
                                                <div class="col-md-6 pt-4">
                                                    <h6 class="mb-0">108 <span
                                                            class="small text-muted">+37.7%</span></h6>
                                                    <p class="mb-0 text-muted">Cost</p>
                                                </div>
                                                <div class="col-md-6 pt-4">
                                                    <h6 class="mb-0">1168 <span
                                                            class="small text-muted">-18.9%</span></h6>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-muted text-center w-25">
                                                    <span class="fe fe-database fe-24"></span><br /> 3218
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-muted text-center w-25">
                                                    <span class="fe fe-cpu fe-24"></span><br /> 2651
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-muted text-center w-25">
                                                    <span class="fe fe-globe fe-24"></span><br /> 2651
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-muted text-center w-25">
                                                    <span class="fe fe-database fe-24"></span><br /> 2757
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-muted text-center w-25">
                                                    <span class="fe fe-cpu fe-24"></span><br /> 2816
                                                </td>
                                                ...
                                                <div class="list-group-item">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="mb-2 text-muted small">Lorem ipsum dolor
                                                                sit amet, <strong>consectetur adipiscing</strong>
                                                                elit. Integer dignissim nulla eu quam cursus
                                                                placerat. Vivamus non odio ullamcorper, lacinia ante
                                                                nec, blandit leo. </div>
                                                            <span
                                                                class="badge badge-pill badge-warning">Security</span>
                                                        </div>
                                                        <div class="col-auto pr-0">
                                                            <small
                                                                class="fe fe-more-vertical fe-16 text-muted"></small>
                                                        </div>
                                                    </div> <!-- / .row -->
                                                </div><!-- / .list-group-item -->
                                                <div class="list-group-item">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="mb-2 text-muted small">Proin porta vel erat
                                                                suscipit luctus. Cras rhoncus felis sed magna
                                                                commodo, in <a href="#!">pretium</a> mauris
                                                                faucibus. Cras rhoncus felis sed magna commodo, in
                                                                pretium mauris faucibus.</div>
                                                            <span class="badge badge-pill badge-success">System
                                                                Update</span>
                                                        </div>
                                                        <div class="col-auto pr-0">
                                                            <small
                                                ...
                                                <div class="list-group-item">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="mb-2 text-muted small"> Morbi id arcu
                                                                convallis, eleifend justo tristique, tincidunt nisl.
                                                                Morbi euismod fermentum quam, at fringilla elit
                                                                posuere a. <strong>Aliquam</strong> accumsan mi
                                                                venenatis risus fermentum, at sagittis velit
                                                                fermentum.</div>
