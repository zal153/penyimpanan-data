        ...
        @if (auth()->user()->role === 'user')
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <li class="nav-item dropdown">
                    <a href="{{ route('user.dashboard') }}" aria-expanded="false" class="nav-link">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="berkas">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('berkas.index') }}"><span class="ml-1">Semua
                                    Berkas</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="./files-shared"><span class="ml-1">Berkas
                                    Dibagikan</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="./files-received"><span class="ml-1">Berkas
                                    Diterima</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="kategori">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="./category-list"><span class="ml-1">Daftar
                                    Kategori</span></a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <li class="nav-item">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="pengguna">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('pengguna.index') }}"><span class="ml-1">Daftar Pengguna</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('pengguna.create') }}"><span class="ml-1">Tambah
                                    Pengguna</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="#storage" data-toggle="collapse" aria-expanded="false"
                        class="dropdown-toggle nav-link">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="storage">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="./storage/overview"><span
                                    class="ml-1">Ringkasan</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="./storage/settings"><span
                                    class="ml-1">Pengaturan</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
